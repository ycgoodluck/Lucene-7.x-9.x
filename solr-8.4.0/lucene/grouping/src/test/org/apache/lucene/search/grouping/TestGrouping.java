	...
	public void testRandom() throws Exception {
		...
		for (int iter = 0; iter < numberOfRuns; iter++) {
			...
			for (int searchIter = 0; searchIter < 100; searchIter++) {
				...
				@SuppressWarnings({"unchecked", "rawtypes"}) final TopGroups<BytesRef> tempTopGroupsBlocks = (TopGroups<BytesRef>) c3.getTopGroups(docSort, groupOffset, docOffset, docOffset + docsPerGroup);
