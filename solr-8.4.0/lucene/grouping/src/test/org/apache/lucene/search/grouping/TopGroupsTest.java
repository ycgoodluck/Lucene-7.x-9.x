...
public class TopGroupsTest extends LuceneTestCase {
	...
	private static GroupDocs<String>[] combineGroupDocs(GroupDocs<String> group0, GroupDocs<String> group1) {
		@SuppressWarnings({"unchecked", "rawtypes"}) final GroupDocs<String>[] groups = new GroupDocs[2];
		groups[0] = group0;
		groups[1] = group1;
		return groups;
	}
	...
	private static TopGroups<String>[] combineTopGroups(TopGroups<String> group0, TopGroups<String> group1) {
		@SuppressWarnings({"unchecked", "rawtypes"}) final TopGroups<String>[] groups = new TopGroups[2];
		groups[0] = group0;
		groups[1] = group1;
		return groups;
	}
