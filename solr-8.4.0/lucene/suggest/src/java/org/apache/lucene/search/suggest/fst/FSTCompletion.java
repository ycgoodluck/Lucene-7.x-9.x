...
public class FSTCompletion {
	 ...
	 *
	 * @param rootArcIndex The first root arc index in {@link #rootArcs} to consider when
	 *                     matching.
	 ...
	 *
	 * @param collectAll If <code>true</code>, the routine terminates immediately when
