...
public final class SearcherManager extends ReferenceManager<IndexSearcher> {
	 ...
	 * @param searcherFactory An optional {@link SearcherFactory}. Pass <code>null</code> if you
	 ...
	 * @param writeAllDeletes If <code>true</code>, new deletes will be forcefully written to index files.
	 * @param searcherFactory An optional {@link SearcherFactory}. Pass <code>null</code> if you
	 *                        don't require the searcher to be warmed before going live or other
	 *                        custom behavior.
	 * @throws IOException if there is a low-level I/O error
