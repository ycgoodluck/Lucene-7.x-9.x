...
final public class QueryParserUtil {
	 ...
	 * @throws IllegalArgumentException if the length of the queries array differs from the length of the
	 *                                  fields array
	 */
	 ...
	 * @param analyzer Analyzer to use
	 * @throws IllegalArgumentException if the length of the fields array differs from the length of the
	 *                                  flags array
	 */
